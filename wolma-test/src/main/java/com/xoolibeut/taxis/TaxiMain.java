...
//				pushPosition(points, "MB0010");
	...
	private static void pushPosition(List<PointMap> points, String matricule) throws Exception {
		...
		Request request = new Request.Builder().url("https://localhost:8443/taxis/v3/pos").post(body).build();
